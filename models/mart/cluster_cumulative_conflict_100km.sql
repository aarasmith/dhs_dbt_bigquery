...
with cluster_stats as (
	select 
		cid,
		year,
		intensity_100km as intensity, 
	case 
		when intensity_100km > 0 
		then 1 
		else 0 
	end conflict_dummy
...
select
	cid,
	year,
	intensity as intensity_100km,
	conflict_dummy as conflict_dummy_100km,
	grp,
	case
		when conflict_dummy = 0
		then 0
		else cumulative_count
	end cumulative_conflict_years_100km
from grouped_counts